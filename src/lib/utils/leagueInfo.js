/*   STEP 1   */
export const leagueID = "1057731861419589632"; // your league ID
...
export const managers = [
{
...

   {
...

    {
      ...
      "managerID": "555493825238970368",  // the user's manager ID, go to https://api.sleeper.app/v1/league/<your_league_id>/users to find user IDs (you can use older leagueIDs to find user IDs for managers that are no longer in the league)
      ...
      "photo": "/managers/bigfoot.jpg", // square ratio recommended (no larger than 500x500)
